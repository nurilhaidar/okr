...
const OkrTypes = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await getOkrTypes(params);
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Manage OKR types (Individual, Team, Department, Company)
          </p>
        </div>
        <button
          onClick={() => {
                ...
                <tr>
                  ...
                  >
                    ...
                    <p className="text-sm mt-1">
                      Create a new OKR type to get started
                    </p>
                  </td>
                </tr>
              ) : (
                  ...
                  >
                    <td className="px-6 py-4">
                      <div className="flex items-center">
                        <div
                          className={`w-10 h-10 ${type.is_employee ? "bg-gradient-to-br from-green-500 to-green-600" : "bg-gradient-to-br from-purple-500 to-purple-600"} rounded-lg flex items-center justify-center mr-3`}
                        >
                          {type.is_employee ? (
                            <svg
                    ...
                    <td className="px-6 py-4">
                      <span
                        className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${type.is_employee ? "bg-green-100 text-green-800" : "bg-purple-100 text-purple-800"}`}
                      >
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div>
                ...
                <div className="flex gap-4">
                  <label
                    className={`flex items-center px-4 py-3 rounded-xl border-2 cursor-pointer transition-all ${!formData.is_employee ? "border-primary bg-blue-50" : "border-gray-200"}`}
                  >
                    <input
                      type="radio"
                      name="is_employee"
                      ...
                      onChange={() =>
                        setFormData({ ...formData, is_employee: false })
                      }
                      className="sr-only"
                    />
                    <svg
                  ...
                  <label
                    className={`flex items-center px-4 py-3 rounded-xl border-2 cursor-pointer transition-all ${formData.is_employee ? "border-primary bg-green-50" : "border-gray-200"}`}
                  >
                    <input
                      type="radio"
                      name="is_employee"
                      ...
                      checked={formData.is_employee}
                      onChange={() =>
                        setFormData({ ...formData, is_employee: true })
                      }
                      className="sr-only"
                    />
                    <svg
