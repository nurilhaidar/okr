                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div>
                            ...
                            <p class="text-muted mb-0">Create an Additional OKR for yourself</p>
                        </div>
                    ...
                    <form method="POST" action="{{ route('okrs.store') }}" id="okrForm">
                        @csrf
                        @method('POST')
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" name="weight" class="form-control" step="0.01" min="0"
                                            max="100" value="{{ old('weight', 100) }}" required>
                                ...
                                <div class="row g-3 mt-1">
                                    <div class="col-md-4">
                                        ...
                                        <input type="hidden" name="okr_type_id" value="{{ $okrTypes->first()?->id }}">
                                    </div>
                                    <div class="col-md-4">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="ti ti-device-floppy me-2"></i>Create OKR
                            </button>
                        </div>
                    </form>
                </div>
...
@section('page_scripts')
    <script>
        ...
        document.getElementById('okrForm').addEventListener('submit', function(e) {
            ...
            .then(data => {
                showToast('Success', data.message || 'OKR created successfully', 'success');
                setTimeout(() => {
            ...
            .catch(error => {
                ...
                if (error.errors) {
                    ...
                    showToast('Error', 'An error occurred while creating the OKR', 'error');
                }
            });
        });
