          ...
          <form method="POST" action="{{ route('admin.employees.store') }}">
            ...
            <div class="d-flex justify-content-end gap-2">
              ...
              <button type="submit" class="btn btn-primary">
                <i class="ti ti-check me-2"></i>Create Employee
              </button>
            </div>
          </form>
        </div>
      ...
      <div class="card mb-4">
        <div class="card-body">
          ...
          <p class="text-muted mb-2">
            Fill in the required fields marked with <span class="text-danger">*</span> to create a new employee.
          </p>
          <ul class="mb-0">
            ...
            <li><strong>Role:</strong> Assign user role (optional)</li>
            <li><strong>Status:</strong> Active employees can log in</li>
          </ul>
        </div>
      </div>
    </div>
