                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-12 col-sm-6 col-lg-3">
                            <a href="{{ route('admin.employees.create') }}" class="btn btn-label-primary d-block h-100 py-4">
                                <i class="ti ti-user-plus fs-2 mb-2"></i>
                                <span class="d-block">Add Employee</span>
                            </a>
                        </div>
                        <div class="col-12 col-sm-6 col-lg-3">
                            <a href="{{ route('admin.roles.create') }}" class="btn btn-label-success d-block h-100 py-4">
        ...
        <div class="col-12 mb-4">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">System Roles <a href="{{ route('admin.roles') }}" class="btn btn-sm btn-primary ms-2">View All</a></h5>
                </div>
                <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-1">
                                                    <button class="btn btn-sm btn-icon btn-outline-primary" onclick="editRole({{ $role->id }}, '{{ $role->name }}', {{ $role->is_active ?? true ? 'true' : 'false' }})">
                                                        <i class="ti ti-pencil"></i>
                                                    </button>
                                                    @if($role->is_active ?? true)
                                                        <button class="btn btn-sm btn-icon btn-outline-warning" onclick="deactivateRole({{ $role->id }})" title="Deactivate">
                                                            <i class="ti ti-player-pause"></i>
                                                        </button>
                                                    @else
                                                        <button class="btn btn-sm btn-icon btn-outline-success" onclick="activateRole({{ $role->id }})" title="Activate">
